...
//         $diff_height = 240 - $im_height;
        $diff_width = 100 - $im_width;
        $diff_height = 100 - $im_height;
     ...
     * 
     * imagecopyresized 
     * 복사 및 크기 조정 및 이미지 처리를 수행합니다. 
     * 이 알고리즘은 픽셀 화 된 결과를 산출하는 매우 원시적 인 알고리즘을 사용합니다.
     * 
     * imagecopyresampled 
     * 복사하고 크기를 조정하고 이미지화합니다. 
     * 일반적으로 더 작은 결과를 얻을 수있는 스무딩 및 픽셀 보간 알고리즘을 사용하고 약간의 CPU 사용량을 감수하면서 imagecopyresized합니다.
     */

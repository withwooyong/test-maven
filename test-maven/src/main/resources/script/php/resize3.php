<?php
	...
	//$stimage_domain = 'http://stimage.hanafostv.com:8080/';
	...
	// 1. image_url : http://stimage.hanafostv.com:8080/ontv/10250/T30222_src.jpg
	if (strpos($image_url, "stimage.hanafostv.com:8080") > 0) {
		// http://1.255.144.53/resize.php?u=http://stimage.hanafostv.com:8080/ontv/10250/T30222_src.jpg&w=228
		$requestFilePath = str_replace("http://stimage.hanafostv.com:8080", "/home/manager/server/images/resize/", $image_url);
		$saveFileName = "/home/manager/server/images/resize/".$image_url;

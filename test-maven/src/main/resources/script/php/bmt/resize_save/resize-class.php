...
class resize {            
    ...
    public function saveImage($savePath, $imageQuality = "100") {
        error_log (date("Y-m-d H:i:s")." resize-class.php saveImage : ".$savePath."\n", 3, "/home/manager/server/nginx_bmt/logs/php_debug.log");
        // *** Get extension
    ...
    public function viewResizeImage($extension, $savePath) {
        error_log (date("Y-m-d H:i:s")." resize-class.php viewImage : ".$savePath."\n", 3, "/home/manager/server/nginx_bmt/logs/php_debug.log");

...
public class Test {
	protected static String brokerURL = "tcp://119.149.188.226:61616";
	...
	public static void main(String[] args) throws Exception {
		...
		ActiveMQDestination destination = (ActiveMQDestination) session.createQueue("FFMPEG.COMMAND");
		
		MessageConsumer consumerAdvisory = session.createConsumer(destination);
		  
		System.out.println("###" + consumerAdvisory.toString());
		
		//consumerAdvisory.setMessageListener(new NoConsumerAdvisoryListener());

...
public class AdvisoryConsumerApp2 implements MessageListener {
	...
	public void before() throws Exception {
		...
		destination = session.createTopic(AdvisorySupport.getNoConsumersAdvisoryTopic(monitored).getPhysicalName());
	...
	public void onMessage(Message message) {
		...
		try {
			...
			if (source.equals(AdvisorySupport.getNoConsumersAdvisoryTopic(monitored))) {
	...
	public static void main(String[] args) {
		...
		AdvisoryConsumerApp2 example = new AdvisoryConsumerApp2();
		System.out.print("\n\n\n");

...
public class BinaryTreeNode {
	...
	// Returns a new BinaryTreeNode equal to (but not the same as) this binary
	// tree.
	...
	// whose
	// root is at this binary tree. That is, for every node in the new binary
	// tree,
	...
	// image
	// of its original structure. No new BinaryTreeNode nodes are created in
	// this
	// process.

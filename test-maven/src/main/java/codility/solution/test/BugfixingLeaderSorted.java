 ...
 * non-decreasing order is given. The leader of this array is the value that
 ...
 * sorted in a non-decreasing order, returns the leader of array A. The
 * function should return −1 if array A does not contain a leader.
 * 
 * 
 * 
 ...
 * it. You should modify at most three lines of code.
 * 
 * 
 * 
 * Assume that:

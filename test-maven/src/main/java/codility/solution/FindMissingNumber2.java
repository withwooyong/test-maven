...
public class FindMissingNumber2 {
	...
	/**
	 * First sort the array and then do a sequential scan of array. 
	 * If difference of any two consecutive numbers is more than 1, then the missing number should be (a[i] + 1)

/*
	...
	2 개의 양의 정수 N과 M이 주어진다. 정수 N은 0에서 N-1까지 번호가 매겨진 원 안에 배열 된 초콜릿의 수를 나타냅니다.
당신은 초콜릿을 먹기 시작합니다. 초콜릿을 먹은 후에는 포장지 만 남겨 두십시오.
당신은 초콜릿 번호 0을 먹기 시작합니다. 그러면 다음 M - 1 초콜릿이나 포장지를 생략하고 다음과 같은 것을 먹습니다.
좀 더 정확히 말하자면, 초콜릿 번호 X를 먹었다면, 다음으로 숫자 (X + M) N (나머지 부분)을 가진 초콜릿을 먹을 것입니다.
빈 래퍼가 발생하면 먹는 것을 멈 춥니 다.

/*
	...
	N 개의 정수로 구성된 0 인덱스 배열 A가 제공됩니다. 그것은 연속 N 일 동안 주식의 일일 가격을 포함합니다. 단일 주식이 P 일에 매수되고 Q가 0 일 때 Q ≤ Q <N 일 때 매매 된 경우, A [Q] ≥ 조건 일 때 그러한 거래의 이익은 A [Q] - A [P]와 같습니다. A [P]. 그렇지 않으면 거래가 A [P] -A [Q]를 잃게됩니다.
...
A [4] = 21013
A [5] = 21367
A [2] - A [0] = 21123 - 23171 = -2048이기 때문에 0 일에 주식을 매수하고 2 일에 매도 한 경우 2048의 손실이 발생합니다. 주식이 4 일에 매수되고 5 일에 팔린다면, A [5] - A [4] = 21367-21013 = 354이기 때문에 354의 이익이 발생합니다. 가능한 최대 이익은 356입니다. 1 일에 구입하여 5 일에 팔았습니다.
함수를 작성하십시오.

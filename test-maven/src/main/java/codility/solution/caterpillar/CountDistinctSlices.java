/*
	...
	정수 M과 N이 음수가 아닌 정수로 구성된 비어 있지 않은 제로 색인 배열 A가 주어집니다. 
	배열 A의 모든 정수는 M보다 작거나 같습니다.
	0 ≤ P ≤ Q <N이되도록 한 쌍의 정수 (P, Q)를 배열 A의 슬라이스라고 부릅니다. 
	슬라이스는 요소 A [P], A [P + 1], ..., A [Q]. 고유 슬라이스는 고유 번호로만 구성된 슬라이스입니다. 
	즉, 슬라이스에서 개별 번호가 두 번 이상 나타나지 않습니다.

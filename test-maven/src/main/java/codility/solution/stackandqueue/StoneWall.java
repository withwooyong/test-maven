/*
	...
	돌담을 세울 것입니다. 벽은 직선이어야하며 길이 Nm이고 두께는 일정해야합니다. 그러나 그것은 다른 장소에서 다른 높이를 가져야합니다. 벽의 높이는 N 개의 양의 정수로 이루어진 제로 색인 배열 H에 의해 지정됩니다. H [I]는 I에서 I + 1 미터까지의 왼쪽 끝의 오른쪽 벽까지의 높이입니다. 특히 H [0]은 벽의 왼쪽 끝의 높이이고, H [N-1]은 벽의 오른쪽 끝의 높이입니다.
벽은 입방 형 석재 블록으로 만들어야합니다 (즉, 그러한 블록의 모든면은 직사각형입니다). 귀하의 임무는 벽을 구축하는 데 필요한 최소 블록 수를 계산하는 것입니다.
함수 작성 :
